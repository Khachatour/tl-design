...
//     let d = Math.sqrt(
//       Math.pow(this.x - points[k].x, 2) + Math.pow(this.y - points[k].y, 2)
//     )
//     if (d < 5) {
//       ctx.lineWidth = 0.2
//       ctx.beginPath()
...
shit.className = 'glitch-window'
document.getElementsByTagName('header')[0].appendChild(shit)
shit.appendChild(document.getElementsByClassName('glitched')[0].cloneNode(true))
